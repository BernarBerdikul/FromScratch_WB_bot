# Generated by Django 4.0 on 2022-01-16 06:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='Имя гостя')),
                ('last_name', models.CharField(blank=True, max_length=64, null=True, verbose_name='Фамилия гостя')),
                ('username', models.CharField(max_length=64, unique=True, verbose_name='Логин гостя')),
            ],
            options={
                'verbose_name': 'Гость',
